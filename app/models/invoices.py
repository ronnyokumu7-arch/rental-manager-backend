...
class Invoice(Base):
    ...
    booking_id = Column(Integer, ForeignKey("bookings.id", ondelete="SET NULL"), nullable=True, index=True)  # NEW
    ...
    booking = relationship("Booking", back_populates="invoices")  # NEW
